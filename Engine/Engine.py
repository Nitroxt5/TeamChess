...
class GameState:
    def __init__(self):
        ...
        # FENAndGSConverter.FENtoGameState("8/k1P5/2K5/8/3P4/3PP1P1/4PPPP/5BQR w - - 0 20", self)
        # FENAndGSConverter.FENtoGameState("Nr1r4/1PRP4/PRPppp2/1P1pkp2/3ppp2/3ppp2/1K6/8 w - - 0 20", self)
